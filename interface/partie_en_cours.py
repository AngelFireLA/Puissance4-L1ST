...
def main_bot_v_bot(profondeur=None):
    ...
    profondeur_bot_1 = 10
    profondeur_bot_2 = 8
    joueur1 = bots.negamaxv5.Negamax5(random.choice(noms_robots), "X", profondeur=profondeur_bot_1)
    temp_de_pensée_max = 5
    joueur2 = bots.negamaxv5.Negamax5(random.choice(noms_robots), "O", profondeur=profondeur_bot_2)
    # joueur2 = Joueur("Joueur 2", "O")
    partie.ajouter_joueur(joueur1)
    partie.ajouter_joueur(joueur2)
    plateau_largeur = partie.plateau.colonnes
