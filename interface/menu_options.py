...
no_sound_image = pygame.image.load(chemin_absolu_dossier+"assets/images/no-volume.png")
...
sound_image = pygame.image.load(chemin_absolu_dossier+"assets/images/volume.png")
